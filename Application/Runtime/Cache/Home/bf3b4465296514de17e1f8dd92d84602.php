...
<body>
	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$book): $mod = ($i % 2 );++$i;?><img src="<?php echo ($book["pic_name_small"]); ?>" />
	<a href="/thinkphp/index.php/Home/Index/detail?isbn=<?php echo ($book["isbn"]); ?>">书名：<?php echo ($book["title"]); ?></a><br />
...
<div class="container">
  ...
  <article class="content">
    <h1>搜索结果</h1>
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$book): $mod = ($i % 2 );++$i;?><section>
